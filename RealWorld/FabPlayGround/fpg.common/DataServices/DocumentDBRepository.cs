...
namespace fpg.common.DataServices
{
    public static class DocumentDBRepository<T>
    {
        ...
        public static async Task<Document> AddVisit(string id, PgItem item)
        {
            Document doc = GetDocument(id);
   
            
            dynamic updatedItem = item.Visit;
            doc.SetPropertyValue("Visit", updatedItem);

            return await Client.ReplaceDocumentAsync(doc);
        }
